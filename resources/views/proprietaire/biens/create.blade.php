        ...
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">
                    {{ __('Ajoutez un nouveau bien avec ses informations principales et sa galerie photos.') }}
                </p>
            </div>
    ...
    <div class="py-8">
        <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm sm:p-8">
                <form method="POST" action="{{ route('proprietaire.biens.store') }}" enctype="multipart/form-data" class="grid gap-8">
                    @csrf
                    ...
                    <div class="flex flex-wrap items-center gap-3 border-t border-gray-200 pt-6">
                        <x-primary-button>{{ __('Enregistrer le bien') }}</x-primary-button>
